...
function onSubmit() {
    ...
    getJsonDataByPost(Globals.baseActionUrl.SELECT_OPERATION_URL,param,"终端分类名称重复校验",
	        function(result){
    			
    			if(result.success == systemVar.SUCCESS && result.total > 0){
    				classInfo["success"] = systemVar.FAIL;
    				classInfo["errormsg"] = "终端分类名称重复";
    			    ...
    			    getJsonDataByPost(Globals.baseActionUrl.ACTION_OPERATION_URL,classInfo,"终端分类维护",
    				        function(result){
